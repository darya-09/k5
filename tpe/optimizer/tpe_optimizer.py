...
from tpe.weight_func import WeightFn
...
class TPEOptimizer(BaseOptimizer):
    def __init__(
        ...
        weight_fn: Optional[WeightFn] = None,    # ДОБАВИТЬ
        weight_low: float = 0.8,                  # ДОБАВИТЬ
        weight_high: float = 1.2,                 # ДОБАВИТЬ
        ...
        self._tpe_samplers = {
            key: TreeStructuredParzenEstimator(
                ...
                weight_fn=weight_fn,      # ДОБАВИТЬ
                weight_low=weight_low,    # ДОБАВИТЬ
                weight_high=weight_high,  # ДОБАВИТЬ
            )
